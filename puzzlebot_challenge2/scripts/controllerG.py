...
class Controller:
    ...
    def __init__(self):
        ...
        self.color = "color"
        # Constantes de PID
        self.linear_kp = 0.3 #rospy.get_param("/linear_Kp", 0.3)
        self.angular_kp = 2 #rospy.get_param("/angular_Kp", 2)
        # Mensajes
        self.msg = Twist()
        self.pose = Pose2D()
        ...
        self.retroColor = rospy.Subscriber("color", String, self.color_callback)
        # Publisher
    ...
    def control(self):
        ...
        if l_error > 0.1 and self.color != "red": #TODO:Agregar condicion de la camara
            ...
            if not self.done and self.color != "red": #TODO Agregar condicion de la camara
                self.done = True
